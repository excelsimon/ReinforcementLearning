...
def main():
    ...
    if os.path.exists('model_dir/steps_11186_reward_-27.569718555278303.ckpt'):
        agent.restore('model_dir/steps_11186_reward_-27.569718555278303.ckpt')
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--env', help='boxed environment name', default='BipedalWalker-v3')
    parser.add_argument(
        '--train_total_steps',
        type=int,
        default=int(2e6),
