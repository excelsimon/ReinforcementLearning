...
def main():
    ...
    if os.path.exists('model_dir/steps_69390_reward_-9.463214959356923.ckpt'):
        agent.restore('model_dir/steps_69390_reward_-9.463214959356923.ckpt')
    ...
    while total_steps < args.train_total_steps:
        ...
        if total_steps // args.test_every_steps >= test_flag:
            ...
            if evaluate_reward >= best_reward:
                ...
                agent.save(ckpt)
    ckpt = 'model_dir/steps_{}_reward_{}.ckpt'.format(total_steps, evaluate_reward)
    agent.save(ckpt)
