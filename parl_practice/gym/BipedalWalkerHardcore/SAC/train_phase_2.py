...
def main():
    ...
    if os.path.exists('model_dir/steps_1481164_reward_-1.6494146736737971.ckpt'):
        agent.restore('model_dir/steps_1481164_reward_-1.6494146736737971.ckpt')
    ...
    while total_steps < args.train_total_steps:
        ...
        if total_steps // args.test_every_steps >= test_flag:
            ...
            if evaluate_reward >= best_reward:
                ...
                # 保存模型
                ckpt = 'model_dir_phase2/steps_{}_reward_{}.ckpt'.format(total_steps, best_reward)
                agent.save(ckpt)
    ckpt = 'model_dir_phase2/steps_{}_reward_{}.ckpt'.format(total_steps, evaluate_reward)
    agent.save(ckpt)
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        '--env', help='boxed environment name', default="BipedalWalkerHardcore-v3")
    parser.add_argument(
        '--train_total_steps',
        type=int,
        default=int(2e6),
